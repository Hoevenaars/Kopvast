    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="order-1 grid gap-6 md:order-2 xl:grid-cols-[1.7fr_0.8fr]">
        <section className="overflow-hidden rounded-2xl border border-ink/10 bg-white">
          ...
          {actions.length === 0 ? (
            <p className="px-5 py-6 text-sm text-ink/45">Niets dat nu wacht. Nieuwe scans, aanvraagacties, voorstelvragen, productie, opdrachten en support verschijnen hier.</p>
          ) : (
